...
namespace SpacedOut.SharedKernel
{
    ...
    public abstract class ValueObject : IEquatable<ValueObject>
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            var propertiesAreEqual = GetProperties().All(p => PropertiesAreEqual(obj, p));
            var fieldsAreEqual = GetFields().All(f => FieldsAreEqual(obj, f));

            return propertiesAreEqual && fieldsAreEqual;
        }
